...
parser.add_argument('-data_loc', type = str, 
                    default = '/vol/tensuser3/dmerkx/databases/flickr8k/flickr_features.h5',
                    help = 'location of the feature file')
parser.add_argument('-split_loc', type = str, 
                    default = '/vol/tensuser3/dmerkx/databases/flickr8k/dataset.json', 
                    help = 'location of the json file containing the data split information')
parser.add_argument('-results_loc', type = str, 
                    default = '/vol/tensuser3/dmerkx/s2i_char_results/',
...
img_net, cap_net = create_encoders('rnn', args.dict_loc, cuda)
