...
parser.add_argument('-cap', type = str, default = 'tokens', help = 'name of the node containing the caption features')
...
char_config = {'embed':{'num_chars': 8384, 'embedding_dim': 300, 'sparse': False, 'padding_idx': 0}, 
               ...
               'bidirectional': False, 'dropout': 0}, 'att':{'in_size': 1024, 'hidden_size': 128}}
