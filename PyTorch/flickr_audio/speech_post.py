...
text_net = audio_gru_encoder(audio_config)

im_params = torch.load(args.results_loc + 'img_model.12')
text_params = torch.load(args.results_loc + 'audio_model.12')
img_net.load_state_dict(im_params)
text_net.load_state_dict(text_params)
if args.gradient_clipping:
    img_clipper = gradient_clipping(clip_value = 0.005)
    text_clipper = gradient_clipping(clip_value = 0.025)
